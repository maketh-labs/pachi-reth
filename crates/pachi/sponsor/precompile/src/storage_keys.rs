...
pub fn sponsor_record_key(sponsor: Address) -> U256 {
...
pub fn sponsor_config_key(sponsor: Address) -> U256 {
...
pub fn sponsor_limit_key(sponsor: Address, limit_context: &[u8]) -> U256 {
...
pub fn sponsor_sender_limit_key(sponsor: Address, sender: Address, limit_context: &[u8]) -> U256 {
    let hash = keccak256(
